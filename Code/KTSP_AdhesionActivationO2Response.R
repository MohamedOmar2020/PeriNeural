...
Genes1 <- read.delim("/Volumes/Macintosh/MechPred/MechPred/USER/Mohamed/MechanisticModels/Genes/GO_Activation.txt")
Genes1 <- as.matrix(Genes1)
Genes1 <- Genes1[-1,]

Genes2 <- read.delim("/Volumes/Macintosh/MechPred/MechPred/USER/Mohamed/MechanisticModels/Genes/GO_Adhesion.txt")
Genes2 <- as.matrix(Genes2)
Genes2 <- Genes2[-1,]

Genes3 <- read.delim("/Volumes/Macintosh/MechPred/MechPred/USER/Mohamed/MechanisticModels/Genes/GO_O2Response.txt")
